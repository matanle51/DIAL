...
class WideResNetDANN(nn.Module):
    ...
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0):
        ...
        self.class_classifier = nn.Linear(nChannels[3], num_classes)

        self.domain_classifier = nn.Sequential(OrderedDict([
            ('d_fc1', nn.Linear(nChannels[3], 100)),
    ...
    def forward(self, input_data, alpha=None):
        ...
        if alpha is not None:
            ...
            # Otherwise, in test, we only apply the WRS-34-10 architecture
