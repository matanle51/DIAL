...
parser = argparse.ArgumentParser(description='DIAL CIFAR100 experiment')
...
parser.add_argument('--model-dir', default='dial/model_cifar100', help='directory of model for saving checkpoint')
...
parser.add_argument('--domain-loss-ratio', default=4, type=float, help='domain regularization in loss function')
...
def main():
    ...
    model = PreActResNetDANN18(num_classes=100, domain_head_type='cifar100').to(device)
        ...
        if epoch % args.test_attack_freq == 0:
            ...
            if robust_acc > best_robust_acc:
                ...
                save_best_robust_model(epoch, model, natural_acc, optimizer, robust_acc,
                                       ...
                                       model_dir=f'{args.model_dir}/best_robust_checkpoint_cifar100.pt')
